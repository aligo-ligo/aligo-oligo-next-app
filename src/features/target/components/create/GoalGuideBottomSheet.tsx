...
import { BottomSheet, Button, Typography } from '@/components/common';
import { SelectableCardList } from '@/components/sections/selectableCardList';
...
interface GoalGuideBottomSheetProps {
  ...
  setValue: UseFormSetValue<TargetType>;
}
